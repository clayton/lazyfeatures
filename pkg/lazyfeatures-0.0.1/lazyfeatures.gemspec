...
Gem::Specification.new do |s|
  ...
  s.extra_rdoc_files = ["lib/lazyfeatures.rb", "lib/lazyfeatures/parser.rb"]
  s.files = ["Rakefile", "lib/lazyfeatures.rb", "lib/lazyfeatures/parser.rb", "Manifest", "lazyfeatures.gemspec"]
